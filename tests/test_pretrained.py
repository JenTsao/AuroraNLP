...
def test_bert_classifier_predict():
    """测试 BERT 分类器预测接口"""
    from AuroraNLP.deep_learning.pretrained import CLASSIFICATION_LABELS, BERTClassifier
...
def test_version_switch():
    """测试版本切换功能"""
    from AuroraNLP.deep_learning.pretrained import HotLoadConfig, HotModelLoader
